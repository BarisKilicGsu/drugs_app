...
func GetEnvironment() *Environment {
	return &Environment{
		...
		DatabaseUrl:     ParseEnv("DATABASE_URL", true, "host=db user=user password=1q2w3e4rR dbname=drugs-app port=5432 sslmode=disable"),
		RedisAddress:    ParseEnv("REDIS_ADDRESS", false, "127.0.0.1:6379"),
		RedisSentinels:  ParseEnv("REDIS_SENTINELS", false, ""),
		RedisPassword:   ParseEnv("REDIS_PASSWORD", false, "1q2w3e4rR"),
